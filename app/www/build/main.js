...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_chords__ = __webpack_require__(195);
...
var HomePage = (function () {
    function HomePage(navCtrl, chordSvc) {
        this.navCtrl = navCtrl;
        this.chordSvc = chordSvc;
    }
    HomePage.prototype.search = function (ev) {
        ...
        if (val && val.trim() != '') {
            this.chordSvc.getChord(val).subscribe(function (response) {
                _this.chordList = response.json();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChordProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__(268);
...
var ChordProvider = (function () {
    function ChordProvider(http) {
        this.http = http;
    }
    ChordProvider.prototype.getChord = function (name) {
        var url = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* BASE_URL */] + '/chord/search/' + name;
        return this.http.get(url);
    };
    return ChordProvider;
}());
ChordProvider = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(255);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_data_chords__ = __webpack_require__(195);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__providers_data_chords__["a" /* ChordProvider */]
        ]
    })
], AppModule);
